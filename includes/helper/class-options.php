...
class Grozomart_Options
{
	...
	public function theme_options()
	{
		CSF::createOptions($this->options_prefix, [
			...
			'show_bar_menu'      => false,
			'ajax_save'          => false,
			// Lets the framework print the CSS declared by each field's
			// 'output' key, which is how the colour/typography controls apply.
			'output_css'         => true,
			'footer_text'        => ''
		]);
	}
		...
		CSF::createSection($this->options_prefix, [
			...
			'fields' => [
				...
				[
					...
					'output'     => '.grozomart-boxed-layout .grozomart-body-content',
					'dependency' => ['site_layout', '==', 'boxed'],
				],
				[
					'id'       => 'body_bg',
		...
		CSF::createSection($this->options_prefix, [
			...
			'fields' => [
				...
				[
					...
					'type'        => 'color',
					'title'       => esc_html__('Loader Text Color', 'grozomart-toolkit'),
					'subtitle'    => esc_html__('Color of the animated loading text.', 'grozomart-toolkit'),
					'output'      => '.preloader .loader',
					'output_mode' => '-webkit-text-stroke-color',
					'dependency'  => ['site_preloader', '==', 'enabled'],
				],
			],
		]);
		...
		CSF::createSection($this->options_prefix, [
			...
			'fields' => [
				...
				[
					...
					'output'      => '.header-main .main-menu ul li .submenu',
					'output_mode' => 'background-color',
				],
				[
					...
					'output'      => '.header-main .main-menu ul li .submenu li',
					'output_mode' => 'border-color',
				],
				[
					...
					'output'      => '.header-main .main-menu ul li .submenu li a',
					'output_mode' => 'color',
				],
				[
					...
					'output'      => '.header-main .main-menu ul li .submenu li a:hover',
					'output_mode' => 'color',
				],
				[
		...
		CSF::createSection($this->options_prefix, [
			...
			'fields' => [
				...
				[
					...
					'output' => '.footer-copyright, .footer-copyright a',
				],
			],
		]);
	}
		...
		CSF::createSection($this->options_prefix, [
			...
			'fields' => [
				...
				[
					...
					'output'           => '.breadcrumb-list, .breadcrumb-list a, .breadcrumb-list li',
					'dependency'       => ['site_page_title', '==', 'enabled'],
				],
			],
		]);
		...
		CSF::createSection($this->options_prefix, [
			...
			'fields' => [
				...
				[
					...
					'type'     => 'button_set',
					'title'    => esc_html__('Post Meta', 'grozomart-toolkit'),
					'subtitle' => esc_html__('Enable or Disable post meta on blog single page', 'grozomart-toolkit'),
					'options'  => [
						'yes' => esc_html__('Yes', 'grozomart-toolkit'),
						'no'  => esc_html__('No', 'grozomart-toolkit'),
					],
		...
		CSF::createSection($this->options_prefix, [
			...
			'fields' => [
				...
				[
					...
					'desc'     => esc_html__('Default: #064C50', 'grozomart-toolkit'),
				],
				[
					'id'       => 'theme2_color',
					'type'     => 'color',
					...
					'desc'     => esc_html__('Default: #BDEB69', 'grozomart-toolkit'),
				],
				[
					'id'       => 'header_color',
					'type'     => 'color',
					...
					'desc'     => esc_html__('Default: #212529', 'grozomart-toolkit'),
				],
				[
					'id'       => 'text_color',
					'type'     => 'color',
					...
					'desc'     => esc_html__('Default: #6B7280', 'grozomart-toolkit'),
				],
				[
					'id'       => 'body_bg_color',
					'type'     => 'color',
					...
					'desc'     => esc_html__('Default: #FFFFFF', 'grozomart-toolkit'),
				],
				[
					'id'       => 'bg_color',
					'type'     => 'color',
					...
					'desc'     => esc_html__('Default: #F5F2EC', 'grozomart-toolkit'),
				],
				[
					'id'       => 'border_color',
					'type'     => 'color',
					...
					'desc'     => esc_html__('Default: #FFFFFF33', 'grozomart-toolkit'),
				],
				[
					'id'       => 'white_color',
					'type'     => 'color',
				...
				[
					...
					'desc'     => esc_html__('Default: #000000', 'grozomart-toolkit'),
				],
			],
		]);
	}
		...
		CSF::createSection($this->options_prefix, [
			...
			'fields' => [
				...
				[
					...
					'subtitle' => esc_html__('<span> and <br> are allowed. Text inside <span> uses the lighter font weight.', 'grozomart-toolkit'),
					'default'  => '<span>' . esc_html__("Sorry, the page you're", 'grozomart-toolkit') . '</span> ' . esc_html__("looking <br> for isn't here.", 'grozomart-toolkit'),
				],
				[
					'id'      => 'error_bottom_message',
					'type'    => 'textarea',
					'title'   => esc_html__('Message', 'grozomart-toolkit'),
					'default' => esc_html__("Don't worry—use the navigation menu or return to the homepage to continue exploring. We're here to help you get back on track quickly and easily.", 'grozomart-toolkit'),
				],
				[
					'id'      => 'error_button_text',
					'type'    => 'text',
					'title'   => esc_html__('Error Button Text', 'grozomart-toolkit'),
					'default' => esc_html__('Back to Home', 'grozomart-toolkit'),
				],
				[
					'id'           => 'error_page_image',
					'type'         => 'media',
					...
					'url'          => false,
					'default'      => [
						'url'       => GROZOMART_TOOLKIT_THEME_ASSETS . '/img/404.png',
						'thumbnail' => GROZOMART_TOOLKIT_THEME_ASSETS . '/img/404.png',
					],
					'preview_size' => 'full',
				],
			],
