		...
		CSF::createSection($this->options_prefix, [
			...
			'fields' => [
				...
				[
					...
					'output'     => '.default-header .grozomart-site-logo img',
					'dependency' => ['site_logo_type', '==', 'image'],
				],
				[
					'id'          => 'logo_max_width',
					...
					'output'      => '.default-header .grozomart-site-logo',
				...
				[
					...
					'title'       => esc_html__('Max Width', 'grozomart-toolkit'),
					'subtitle'    => esc_html__('Logo wrapper max width', 'grozomart-toolkit'),
					'output'      => '.grozomart-nav-menu .slide-panel-wrapper .slide-panel-logo',
					'output_mode' => 'max-width',
				],
			],
		]);
		...
		CSF::createSection($this->options_prefix, [
			...
			'fields' => [
				...
				[
					...
					'output'      => '.grozomart-site-footer.default-footer',
					'output_mode' => 'background-color',
				],
				[
					'id'     => 'copyright_color',
					...
					'output' => '.grozomart-site-footer .footer-copyright, .grozomart-site-footer .footer-copyright a',
				],
			],
		]);
	}
		...
		CSF::createSection($this->options_prefix, [
			...
			'fields' => [
				...
				[
					...
					'output'           => '.grozomart-breadcrumb, .grozomart-breadcrumb a, .grozomart-breadcrumb span',
					'dependency'       => ['site_page_title', '==', 'enabled'],
				],
			],
		]);
