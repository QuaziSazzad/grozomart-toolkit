<?php if ('layout_one' == $settings['layout_type']) : ?>
    ...
    <section class="shop-category-section fix section-padding pt-0">
        <div class="container">
            <div class="shop-category-wrapper">
                <div class="swiper shop-category-slider">
                    <div class="swiper-wrapper">
                        <?php if (!empty($settings['layout_one_category_items'])) : ?>
                            <?php foreach ($settings['layout_one_category_items'] as $item) : ?>
