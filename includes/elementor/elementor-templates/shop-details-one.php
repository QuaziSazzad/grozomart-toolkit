...
<?php
     ...
     */
    $details_product_id = !empty($settings['layout_one_product']) ? absint($settings['layout_one_product']) : get_the_ID();
...
?>
    ...
    <section class="shop-details-section section-padding pb-0 fix">
        <div class="container">
            ...
            <?php endif; ?>
            <div class="shop-details-simple-wrapper">
                <div class="row g-4">
                    <div class="col-lg-6">
                        <div class="shop-details-left-item">
                            ...
                            <?php if ('yes' === $settings['layout_one_show_gallery'] && count($details_image_ids) > 1) : ?>
                                <ul class="nav">
                                    <?php foreach ($details_image_ids as $details_index => $details_image_id) : ?>
                                        <li class="nav-item">
                    ...
                    <div class="col-lg-6">
                        <div class="shop-details-simple-content">
                            ...
                            if (empty($details_short)) {
                                $details_short = wp_trim_words($details_product->get_description(), 45);
                            }
                            if (!empty($details_short)) :
                            ?>
                            ...
                            <?php if ($details_product->is_type('simple') && $details_product->is_purchasable() && $details_product->is_in_stock()) : ?>
                                <?php
                                /**
                            ...
                            <?php if (!empty($settings['layout_one_checklist_items'])) : ?>
                                <ul class="check-list-items">
                                    <?php foreach ($settings['layout_one_checklist_items'] as $details_check_item) : ?>
                                        <li>
                                            <div class="icon">
                                                <i class="fa-solid fa-check"></i>
                                            </div>
                                            <span>
                                                <?php if (!empty($details_check_item['label'])) : ?>
                                                    <b><?php echo esc_html($details_check_item['label']); ?></b>
                                                <?php endif; ?>
                                                <?php echo esc_html($details_check_item['text']); ?>
                                            </span>
                                        </li>
                                    <?php endforeach; ?>
                                </ul>
                            ...
                            <?php if ('yes' === $settings['layout_one_show_meta']) : ?>
                                <ul class="list border-0 pb-0">
                                    <?php if ($details_product->get_sku()) : ?>
                                        <li>
                                            <span class="style-one"><?php esc_html_e('SKU:', 'grozomart-toolkit'); ?></span>
                                            <span><?php echo esc_html($details_product->get_sku()); ?></span>
                                        </li>
                                    <?php endif; ?>
    ...
    <?php if ('yes' === $settings['layout_one_show_tabs']) :
         ...
         */
        $details_related_ids = wc_get_related_products($details_id, (int) $settings['layout_one_related_limit']);
                    ...
                    <ul class="nav">
                        <li class="nav-item wow fadeInUp" data-wow-delay=".2s">
                            <a href="<?php echo esc_attr('#desc-' . $details_uid); ?>" data-bs-toggle="tab" class="nav-link active">
                                <?php echo esc_html($settings['layout_one_description_label']); ?>
                            </a>
                        </li>
                        <li class="nav-item wow fadeInUp" data-wow-delay=".4s">
                            <a href="<?php echo esc_attr('#info-' . $details_uid); ?>" data-bs-toggle="tab" class="nav-link">
                                <?php echo esc_html($settings['layout_one_additional_label']); ?>
                            </a>
                        </li>
                        <li class="nav-item wow fadeInUp" data-wow-delay=".6s">
                            <a href="<?php echo esc_attr('#reviews-' . $details_uid); ?>" data-bs-toggle="tab" class="nav-link">
                                <?php echo esc_html($settings['layout_one_reviews_label']); ?>
                            </a>
                        </li>
                        <li class="nav-item wow fadeInUp" data-wow-delay=".8s">
                            <a href="<?php echo esc_attr('#related-' . $details_uid); ?>" data-bs-toggle="tab" class="nav-link">
                                <?php echo esc_html($settings['layout_one_related_label']); ?>
                            </a>
                        </li>
                    </ul>
                    <div class="tab-content">
                            ...
                            <div class="row g-4">
                                <div class="decption-content">
                                    <h3 class="decption-title">
                                        <?php echo esc_html(!empty($settings['layout_one_description_heading']) ? $settings['layout_one_description_heading'] : $details_product->get_name()); ?>
                                    </h3>
                                    <?php
                                    /**
                                     ...
                                     */
                                    if (!empty($settings['layout_one_description_text'])) {
                                        echo wp_kses_post($settings['layout_one_description_text']);
                                    } else {
                                    ...
                                    ?>
                                    <?php if (!empty($settings['layout_one_description_list'])) : ?>
                                        <?php
                                        /**
                                         ...
                                         * list.
                                         */
                                        $details_dec_items  = $settings['layout_one_description_list'];
                                ...
                                <div class="row">
                                    <div class="col-xl-12">
                                        <div class="shop-review">
                                             ...
                                             *
                                             * wc_get_template() still honours a theme override at
                                             ...
                                             * It also prints its own heading and review list,
                                             * already rendered above in this design, so
                                             * `.grozomart-wc-review-form` hides those duplicates
                                             * (see the widget's inline style) and keeps the form.
                                             */
                            ...
                            <div id="<?php echo esc_attr('related-' . $details_uid); ?>" class="tab-pane fade">
                                <div class="section-title-area">
                                    <div class="section-title">
                                        <h2><?php echo esc_html($settings['layout_one_related_title']); ?></h2>
                                    </div>
                                    <?php if (!empty($settings['layout_one_related_link']['url'])) : ?>
                                        <a href="<?php echo esc_url($settings['layout_one_related_link']['url']); ?>" class="theme-btn small-btn"><?php esc_html_e('View All', 'grozomart-toolkit'); ?></a>
                                    <?php endif; ?>
                                </div>
