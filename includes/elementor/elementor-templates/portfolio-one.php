            ...
            <div class="row justify-content-center">
                <?php if ('cpt' == $settings['portfolio_type']) : ?>
                    ...
                    if ('categories' == $settings['post_from'] && $settings['cat_slugs']) {
                        $args['tax_query'] = [
                            [
                                'taxonomy' => 'grozomart_portfolio_category',
                                'field'    => 'slug',
                    ...
                    while ($wp_query->have_posts()): $wp_query->the_post();
                        $idd             = get_the_ID();
                        $categories_list = get_the_terms($idd, 'grozomart_portfolio_category', '', '', '');

                        $portfolio_meta = get_post_meta($idd, 'grozomart_portfolio_meta', true);
                                    ...
                                    <?php if ('yes' === $settings['show_category']) : ?>
                                        <div class="tags">
                                            <?php if (!empty($categories_list[0]->name)) : ?>
                                                <a href="<?php echo esc_url(get_term_link($categories_list[0]->term_id, 'grozomart_portfolio_category')); ?>"><?php echo esc_html($categories_list[0]->name); ?></a>
                                            <?php endif; ?>
                                            <?php if (!empty($categories_list[1]->name)) : ?>
                                                <a href="<?php echo esc_url(get_term_link($categories_list[1]->term_id, 'grozomart_portfolio_category')); ?>"><?php echo esc_html($categories_list[1]->name); ?></a>
                                            <?php endif; ?>
                                        </div>
                                    <?php endif; ?>
                                    <<?php echo grozomart_escape_tags($settings['title_tag']); ?> class="title">
                                        <a href="<?php the_permalink(); ?>"><?php echo grozomart_kses_basic($the_title); ?></a>
                                    </<?php echo grozomart_escape_tags($settings['title_tag']); ?>>
                    ...
                    ?>
                            ...
                            ?>
                                <div class="col-xxl-4 col-md-6" data-aos="fade-up" data-aos-delay="200" data-aos-duration="1500" data-aos-offset="50">
                                    <div class="feature-item style-two hover-content">
                                        <div class="image">
                                            <?php grozomart_elementor_rendered_image($portfolio, 'image'); ?>
                                        </div>
                                        <div class="content">
                                            <?php if ('yes' === $settings['show_category']) : ?>
                                                <div class="tags">
                                            ...
                                            <<?php echo grozomart_escape_tags($settings['title_tag']); ?> class="title">
                                                <a href="<?php the_permalink(); ?>">
                                                    ...
                                                    if (!empty($portfolio['title'])):
                                                        echo grozomart_kses_basic($portfolio['title']);
                                                    else:
                                                        echo grozomart_kses_basic($the_title);
                                                    endif;
                                                    ?>
                                                </a>
                                            </<?php echo grozomart_escape_tags($settings['title_tag']); ?>>
