                            ...
                            <div class="faqs-left-content rmb-50" data-aos="fade-right" data-aos-duration="1500" data-aos-offset="50">
                                ...
                                <div class="section-title mb-50">
                                    <?php if (!empty($settings['layout_six_subtitle'])) : ?>
                                        <span class="sub-title mb-10"><?php echo grozomart_kses_basic($settings['layout_six_subtitle']); ?></span>
                                    <?php endif; ?>
                                    <?php if (!empty($settings['layout_six_title'])) : ?>
                                        <<?php echo esc_attr($settings['layout_six_title_tag']); ?>><?php echo grozomart_kses_basic($settings['layout_six_title']); ?></<?php echo esc_attr($settings['layout_six_title_tag']); ?>>
                                    <?php endif; ?>
                                </div>
                                <?php if (!empty($settings['layout_six_button_text'])) : ?>
                                    <a href="<?php echo esc_url($settings['layout_six_button_url']['url']); ?>" <?php if (!empty($settings['layout_six_button_url']['is_external'])) : ?> target="_blank" <?php endif; ?> class="theme-btn"><?php echo grozomart_kses_basic($settings['layout_six_button_text']); ?></a>
                                <?php endif; ?>
                            </div>
                        </div>
                        <div class="col-lg-7">
