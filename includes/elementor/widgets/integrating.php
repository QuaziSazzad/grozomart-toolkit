...
class Integrating extends Widget_Base
{
	...
	{
		return esc_html__('Integrating', 'grozomart-toolkit');
	}
	...
	{
		return ['grozomart', 'toolkit', 'webtend', 'integrating'];
	}
	...
	protected function register_controls()
	{
		...
		include grozomart_get_elementor_option('integrating-one-option.php');
		...
		grozomart_elementor_style_options($this, 'Section Summary Text', '{{WRAPPER}} .summary-text', ['layout_one']);
	...
	protected function render()
	{
		...
		include grozomart_get_elementor_template('integrating-one.php');
	}
}
