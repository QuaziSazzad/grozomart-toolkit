...
$this->add_control(
	'layout_three_show_wishlist_row',
	[
...
$this->add_control(
	...
	[
		...
		'condition' => ['layout_three_show_meta' => 'yes'],
	]
);
...
$layout_three_icon = new \Elementor\Repeater();

$layout_three_icon->add_control(
	'icon',
	[
...
$this->add_control(
	'layout_three_icon_items',
	[
		'label' => esc_html__('Items', 'grozomart-toolkit'),
		'type' => \Elementor\Controls_Manager::REPEATER,
		'fields' => $layout_three_icon->get_controls(),
		'title_field' => '{{{ text }}}',
		'default' => [
...
$layout_three_dec_list = new \Elementor\Repeater();

$layout_three_dec_list->add_control(
	'text',
	[
		'label' => esc_html__('Text', 'grozomart-toolkit'),
		'type' => \Elementor\Controls_Manager::TEXT,
...
$this->add_control(
	'layout_three_description_list',
	[
		'label' => esc_html__('Feature List', 'grozomart-toolkit'),
		'type' => \Elementor\Controls_Manager::REPEATER,
		'fields' => $layout_three_dec_list->get_controls(),
		'title_field' => '{{{ text }}}',
