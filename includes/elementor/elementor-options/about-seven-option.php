...
$this->add_control(
	...
	[
		...
		'default' => esc_html__('Best talent, Competitive Cost, Incredible IT Service Infrastructure', 'grozomart-toolkit'),
		'label_block' => true,
	]
);
...
$repeater->add_control(
	...
	[
		'label' => esc_html__('Title', 'grozomart-toolkit'),
		'type' => \Elementor\Controls_Manager::TEXT,
		'default' => esc_html__('Awards Winning Company', 'grozomart-toolkit'),
		'label_block' => true,
	]
);
...
$repeater->add_control(
	...
	[
		...
		'type' => \Elementor\Controls_Manager::TEXTAREA,
		'default' => esc_html__('Sed ut perspiciat unde omnis este natus error sit voluptatem accusantium doloremque', 'grozomart-toolkit'),
		'label_block' => true,
	]
);
...
$repeater->add_control(
	'link_text',
	[
		'label' => esc_html__('Link Text', 'grozomart-toolkit'),
		'type' => \Elementor\Controls_Manager::TEXT,
	...
	[
		...
		'default' => [
			[
				...
				'title' => esc_html__('Awards Winning Company', 'grozomart-toolkit'),
				'description' => esc_html__('Sed ut perspiciat unde omnis este natus error sit voluptatem accusantium doloremque', 'grozomart-toolkit'),
				'link_text' => esc_html__('Read More', 'grozomart-toolkit'),
				'link' => [
					'url' => '#',
				],
			],
			[
				...
				'title' => esc_html__('Startup IT Solution & Business Dev', 'grozomart-toolkit'),
				'description' => esc_html__('Sed ut perspiciat unde omnis este natus error sit voluptatem accusantium doloremque', 'grozomart-toolkit'),
				'link_text' => esc_html__('Read More', 'grozomart-toolkit'),
				'link' => [
					'url' => '#',
